...
# ══════════════════════════════════════════════════════════════════════
# Auth (placeholder — SSO/AD will be connected later)
# ══════════════════════════════════════════════════════════════════════

app.add_api_route("/login", _page("pages/login.html", "Вход", "login"),
                  methods=["GET"], response_class=HTMLResponse)
app.add_api_route("/logout", _page("pages/logout.html", "Выход", "logout"),
                  methods=["GET"], response_class=HTMLResponse)
