...
RC0 заморожен для бизнес-демонстрации. Все 5 P0 физических блокировок задокументированы (B-01, B-02, B-03, B-04, B-06). B-05 (пилотный runbook) ранее разрешён.

### Статус документов

Все документы RC0 созданы:
- Контрольный список заморозки RC0
- Маршрут бизнес-демонстрации
- Контрольный список бизнес-приёмки
- Примечания к выпуску RC0

Физический пилот остаётся заблокированным до снятия всех 5 P0 блокировок.
